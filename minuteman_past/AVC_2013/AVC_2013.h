...
#define WAYPOINT_ACCEPT 40	//waypoint acceptance radius in inches
...
#define S4 1640 			//1680 is pretty ridiculously fast. Don't use for general use. maybe try 1650, 1720 fastest
...
#define P3 200				//far proximity to waypoint in inches 625?
