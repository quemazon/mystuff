...
#define DEBUG 2				//debug state  1=cal gyro, 2=watch angle, 3=read waypoints
#define GYRO_LIMIT 500		//defines how many gyro samples are taken between angle calculations
...
void calculate_null() {
	...
	gyro_null = angle/500;	//calculate the null
