...
x32 - path forward: ignore gps heading correct between corners of building or when it is > 20-ft of waypoint
x33 - still use the gps to determine distance
x34 - choose waypoints a great distance to reduce possible heading change
x35 - use ultrasonic sensors to avoid curbs
x36 - develop a correct method/procedure for programming waypoints and driving them consistently
x37 - clean up lcd outputs
x38 - set up the ultrasonic sensor on an interrupt
x39 - during the competition...make sure the final waypoint is ~20 feet beyond the finish line
*/
