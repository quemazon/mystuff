...
data = repr(data)
#print data
data = data.partition("Fm ")[2]
#print data
data = data.replace(" To ", ">")
#print data
data = data.partition(" ")[0] + ":" + data.partition("]\\r")[2]
#print data
data = data.partition("\\r\\r")[0]
...
if __name__=='__main__':
    packets=[
        ...
        #"""W5YYY-5/WIDE2>APDR11>UI,C,F0:=3552.95N/10619.40W$ http://aprsdroid.org/"""
        #,"""W5YYY-5>APDR11:=3552.95N/10619.40W$ http://aprsdroid.org/"""
        ]
    packets.append(data)
    for p in packets:
        print p
        #x=UIFrame(p)
        x=AprsFrame(p)
        print "lat =", x.payload.latitude, "lon = ", x.payload.longitude
